...
public class WechatMicroRequest extends WechatRequestBase {
	...
	public String getCallback_ur() {
		return callback_ur;
	}

	public void setCallback_ur(String callback_ur) {
		this.callback_ur = callback_ur;
	}
