...
public class WechatWebPayRequest extends AbstractBase {
	...
	public WechatWebPayRequest(String key, String service_type, String mch_id, String out_trade_no, String body,
			String total_fee, String spbill_create_ip, String notify_url, String nonce_str, String attach, Logger log) {
	...
	public WechatWebPayRequest(String key, String service_type, String mch_id, String out_trade_no, String body,
			String total_fee, String spbill_create_ip, String notify_url,String callback_url, String nonce_str, String attach, Logger log) {
		setService_type(service_type);
		setMch_id(mch_id);
		setOut_trade_no(out_trade_no);
		setBody(body);
