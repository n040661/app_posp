package xdt.dto.nbs.orderquery;
...
public class WechatOrderQueryRequest extends WechatRequestBase {
	...
	public WechatOrderQueryRequest(String key, String service_type, String mch_id, String out_trade_no,
			String nonce_str, Logger log) {
