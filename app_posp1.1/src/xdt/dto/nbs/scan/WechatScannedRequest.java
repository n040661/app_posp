...
public class WechatScannedRequest extends WechatRequestBase {
	...
	public WechatScannedRequest(String key, String service_type, String appid, String mch_id, String device_info,
			String nonce_str, String body, String detail, String attach, String out_trade_no, String fee_type,
			String total_fee, String spbill_create_ip, String time_start, String time_expire, String op_user_id,
			String goods_tag, String notify_url, String product_id, String limit_pay, Logger log) {
	...
	public WechatScannedRequest(String key, String service_type,String mch_id, String nonce_str,String body,String out_trade_no,String total_fee, String spbill_create_ip, String notify_url, Logger log) {
		setService_type(service_type);
		setMch_id(mch_id);
		// 随机字符串，不长于32 位
		setNonce_str(nonce_str);
