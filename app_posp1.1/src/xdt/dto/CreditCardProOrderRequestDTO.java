 ...
 */
public class CreditCardProOrderRequestDTO {
    public String collectName;//持卡人姓名
    public String collectAccNo; //持卡人卡号
    public String collectBankName;//持卡人卡号所属银行名称
    public String collectBankId;//持卡人银行编号
