...
public class YSZFThread extends Thread{
Logger log = Logger.getLogger(this.getClass());
	...
	public YSZFThread(ITotalPayService service, String mer, String orderId, DaifuRequestEntity payRequest,
	...
	public void run() {
		...
		try {
			Thread.sleep(2000);
			for (int i = 0; i < 30; i++) {
			 map= service.yszfQuick(mer, orderId);
			 if(map!=null){
