...
public class PlatHttpClient {
	 ...
	 *            HTTP读写超时时间
	 */
	public PlatHttpClient(String url, int connectionTimeout, int readTimeOut) {
		try {
	...
	private String response(final HttpURLConnection connection, String encoding)
		...
		try {
			...
			PlatLogUtil.writeLog("HTTP Return Status-Code:["
	...
	private String getRequestParamString(Map<String, String> requestParam,
		...
		PlatLogUtil.writeLog("请求报文(已做过URLEncode编码):[" + reqstr + "]");
		return reqstr;
	}
