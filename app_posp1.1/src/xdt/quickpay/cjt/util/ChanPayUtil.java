...
public class ChanPayUtil {
	...
	/**
     * 建立请求，以模拟远程HTTP的POST请求方式构�?并获取钱包的处理结果
     * 如果接口中没有上传文件参数，那么strParaFileName与strFilePath设置为空�?如：buildRequest("",
     * "",sParaTemp)
     *
    ...
    public static String buildRequestByMD5(Map<String, String> sPara, String key,
                                           String inputCharset) throws Exception {
        String prestr = createLinkString(sPara, false); // 把数组所有元素，按照“参�?参数值�?的模式用�?”字符拼接成字符�?
    ...
    public static String buildRequestByRSA(Map<String, String> sPara, String privateKey,
        ...
        System.out.println("buildRequestByRSA======加密前排序后�?=====" + prestr + "======加密后串======" +  mysign);
        return mysign;
    }
