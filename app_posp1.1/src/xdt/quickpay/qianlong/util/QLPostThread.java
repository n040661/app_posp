...
public class QLPostThread extends Thread {
	
	public static final Logger logger=Logger.getLogger(QLPostThread.class);
	
	private String url;
	
	private PayResponseEntity entity;

	public QLPostThread(String url, PayResponseEntity entity) {
		this.url = url;
		this.entity = entity;
	}
	@Override
