...
public class SignatureUtil {
	...
	public static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(SignatureUtil.class);
	/**
	 * 签名算法
	 *
	 * @param o
	 ...
	 * @date 2016年11月11日 下午2:53:33
	 */
	public static String getSign(Map<String, Object> map, String key, org.apache.log4j.Logger log) {
		ArrayList<String> list = new ArrayList<String>();
		for (Map.Entry<String, Object> entry : map.entrySet()) {
			if (entry.getValue() != null && StringUtil.isNotBlank(String.valueOf(entry.getValue()))) {
				list.add(entry.getKey() + "=" + entry.getValue() + "&");
	 ...
	 * @date 2016年11月11日 下午5:21:21
	 */
	public static boolean checkSign(Map<String, Object> map, String key, org.apache.log4j.Logger log) {
		log.info("校验签名的数据:"+ map.toString());
