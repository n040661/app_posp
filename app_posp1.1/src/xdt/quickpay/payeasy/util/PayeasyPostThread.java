...
public class PayeasyPostThread extends Thread{
	
public static final Logger logger=Logger.getLogger(JsPostThread .class);
	
	private String url;
	
	private PayEasyResponseEntitys entity;
	

	public PayeasyPostThread(String url, PayEasyResponseEntitys entity) {
		super();
		this.url = url;
		this.entity = entity;
	}
		...
		try {
				...
				for(int i=0;i<1000;i++){
					...
					String result = HttpURLConection.httpURLConnectionPOST(url,
							bean2Util.bean2QueryStr(entity));
