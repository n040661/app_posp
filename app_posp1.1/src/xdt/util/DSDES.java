...
public class DSDES {
  ...
  public static void main(String[] args) throws Exception{
	...
	String deses = DSDES.getBlackData("1b2aeaa4".getBytes(), "returncode=25&errtext=余额不足或其他错误&merchno=SHID20180704093&dsorderid=1530757612454&amount=0.02&orderid=null&transdate=20180705&transtime=103628".getBytes("utf-8"));
