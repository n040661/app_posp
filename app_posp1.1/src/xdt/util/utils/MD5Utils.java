...
public class MD5Utils {
     ...
     * @throws Exception
     */
    public static String sign(String paramSrc,String key,String code) {
        String sign = md5(paramSrc + "&key=" + key,code);
     ...
     * @return
     */
    public static boolean verify(String source, String tfbSign,String key,String code) {
        String sign = md5(source + "&key=" + key, code);
