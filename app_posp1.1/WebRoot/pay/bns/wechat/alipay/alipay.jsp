...
<body>
	<fieldset>
		...
		<p>
			授权码:<input type="text" class="auth_code" name="auth_code" value="" />
		</p>
		<p>
			设备号:<input type="text" class="device_info" name="device_info" value="<%=UtilDate.getDate()%>" />
		</p>
		<p>
			支付场景:<select name="scene" class="scene">
			    <option selected="selected" value="">请选择...</option>
				<option  value="bar_code">条码</option>
				<option value="wave_code">声波</option>
			</select>
		</p>
		<p>
			交易类型:<select name="service_type" class="service_type">
				<option selected="selected" value="1">支付宝扫码</option>
				<option value="2">支付宝刷卡</option>
