...
<center>
	...
	联行号:<input type="text" name="pmsbankNo" class="pmsbankNo" value="103100000026" /><br /><br />
	省份:<input type="text" name="province" class="province" value="天津市" /><br /><br />
	城市:<input type="text" name="city" class="city" value="天津市" /><br /><br />
	借记卡费率:<input type="text" name="debitRate" class="debitRate" value="0.0046" /><br /><br />
	单笔提现手续费:<input type="text" name="withdrawDepositSingleFee" class="withdrawDepositSingleFee" value="350" /><br /><br />
	唯一标识:<input type="text" name="merchantCode" class="merchantCode" value="95fc250220cd41ec98d5071d8fdc2cc3" /><br /><br />
