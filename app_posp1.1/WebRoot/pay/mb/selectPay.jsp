...
<center>
	...
	订单号:<input type="text" class="orderId" name="orderId" value="CJZF1502333544638">
...
<script type="text/javascript">
	function chaxun(){
		...
		var data={"merId":merId,"orderId":orderId,"type":"cj004"};
		$.ajax({
			...
			success:function(data){
				console.info(data);
				var data1={"merId":merId,"orderId":orderId,"sign":data,"type":"cj004"};
				$.ajax({
