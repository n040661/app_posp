...
<form id="form"
		...
		<center>
			<table>
				...
				<tr>
					<td>卡号：</td>
					<td><input type="text" name="accNo" value="6212260302026649095"></td>
				</tr>
								<tr>
					<td>前台通知地址：</td>
					<td><input type="text" name="frontUrl" value="http:60.28.24.164:8102/app_posp/hfquick/hfpagePayResult.action"></td>
				</tr>
								<tr>
					<td>后台通知地址：</td>
					<td><input type="text" name="backUrl" value="http:60.28.24.164:8102/app_posp/hfquick/hfbgPayResult.action"></td>
				</tr>
				<tr>
