...
<center>
		...
		银行卡号：<input type="text" name ="userCardNo" class="userCardNo" value="6228450028016697770"><br/><br/>
		手机号：<input type="text" name ="userTel" class="userTel" value="13323358548"><br/><br/>
		异步通知：<input type="text" name="notifyUrl" class="notifyUrl" value="http://60.28.24.164:8104/app_posp/TFBController/notifyUrl.action"><br/><br/>
	...
	function shengcheng(){
		$.ajax({
			...
			success:function(data){
				$.ajax({
					url:"${pageContext.request.contextPath}/HMController/pay.action",
					type:"post",
