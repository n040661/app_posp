...
<div class="Withdrawals" style="margin-top: 3%;overflow-x: hidden;">
	...
	<div class="Numbers">
		...
		<div class="mima"><input type="text" id="batch_no"  readonly="readonly" style="color:#000000;border:none;vertical-align:middle;height:57px;line-height:57px;font-size: 30px;" value="<%=request.getParameter("orderid") %>"></div>
		<div class="clear"></div>
		<div class="clear"></div> 
	</div>
