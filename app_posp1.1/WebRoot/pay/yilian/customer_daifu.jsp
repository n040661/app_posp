...
<table>
	...
	<tr>
		<td>户名:</td>
		<td><input type="text" class="ACC_NAME" name="ACC_NAME" id="ACC_NAME" value="${realName}" style="color:#000000;font-size:15px;" onfocus="test1(this)" readonly="readonly" onblur="test2(this)"></td>
	</tr>
	<tr>
		<td>结算卡号:</td>
		<td><input type="text" class="ACC_NO" name="ACC_NO" id="ACC_NO" title="非必填后期填也可以"  style="color: #000000;font-size:15px;" readonly="readonly" value="${cardNo}"  readonly="readonly" onfocus="test1(this)" onblur="test2(this)"></td>
	</tr>
	<tr>
...
<div>
<input id="btn-upload" type="button" value="确认提现" onclick="tijiao()" style="background-color:#87CEEB;width:250px;height:30px;border:none;margin-left: 4%;">
</div>
</div>
<script type="text/javascript">
					...
					success:function(data){
						...
						$.each(data.BODYS,function(index,datas){
							...
							if(datas.PAY_STATE=='00A4'){
								...
								window.location.href="http://localhost:8103/app_posp/pay/yilian/success.jsp?batch_no="+BATCH_NO+"&orderid="+orderid;
							}else{
								window.location.href="http://localhost:8103/app_posp/pay/yilian/fail.jsp?batch_no="+BATCH_NO+"&orderid="+orderid;
							}
						});
