...
<div class="Withdrawals" style="margin-top: 3%;overflow-x:hidden;">
	...
	<div class="Numbers">
		<div class="dahai">支付单号：</div>
		<div class="mima"><input type="text" readonly="readonly" id="orderid" value="<%=request.getParameter("orderid")%>" style="color:#000000;border:none;"></div>
		<div class="clear"></div> 
	</div>
	<div class="Numbers">
		<div class="dahai">提现单号：</div>
		<div class="mima"><input type="text" id="batch_no" readonly="readonly" value="<%=request.getParameter("batch_no")%>" style="color:#000000;border:none;"></div>
		<div class="clear"></div> 
	</div>
	<div class="Success">提现成功</div>
