	...
	<div id="one">
		<form action="" name="demoOneForm" id="demoOneForm" method="post">
			<table>
				...
				<tr>
					<th>银行卡号：</th>
					<td><input type="text" style="width:350px;" name="cardNo" value="6228480028165389678"/></td>
				</tr>
				<tr>
					<th>用户姓名：</th>
					<td><input type="text" style="width:350px;" name="name" value="于海涛"><br/></td>
				</tr>
				<tr>
					<th>身份证号：</th>
					<td><input type="text" style="width:350px;" name="idCardNo" value="231121198112245414"></td>
				</tr>
				<tr>
					<th>商户编号：</th>
...
$("#tj").click(function(){
	demoOneForm.action='${pageContext.request.contextPath}/dk/querySubContractId.action';
	demoOneForm.submit();
})
</script>
</html>