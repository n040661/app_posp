	...
	<div id="one">
		<form action="" name="demoOneForm" id="demoOneForm" method="post">
			<table>
				...
				<tr>
					<th>子协议编号：</th>
					<td><input type="text" style="width:350px;" name="subContractId" value="11006"></td>
				</tr>
				<tr>
					<th>扣款目的：</th>
				...
				<tr>
					<th>金额：</th>
					<td><input type="text" style="width:350px;" name="amount" value="3.00"></td>
				</tr>
			    <tr>
					<th>回调地址：</th>
				...
				<tr>
					<th>手机号：</th>
					<td><input type="text" style="width:350px;" name="phoneNo" value="18622883268"></td>
				</tr>
				<tr>
					<td></td>
...
$("#pay").click(function(){
	demoOneForm.action='${pageContext.request.contextPath}/ysb/hfsignmessage.action';
	demoOneForm.submit();
})
</script>
</html>