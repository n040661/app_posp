	...
	<div id="one">
		<form action="" name="demoOneForm" id="demoOneForm" method="post">
			<table>
				...
				<tr>
					<th>子协议开始时间：</th>
					<td><input type="text" class="Wdate" style="width:350px;" name="startDate"  onfocus="WdatePicker({isShowClear:false,readOnly:true})" value="20170810"/></td>
				</tr>
				<tr>
					<th>子协议结束时间：</th>
					<td><input type="text" class="Wdate" style="width:350px;" name="endDate" onfocus="WdatePicker({isShowClear:false,readOnly:true})" value="20180101"></td>
				</tr>
				<tr>
					<th>商户编号：</th>
				...
				<tr>
					<th>子协议编号：</th>
					<td><input type="text" style="width:350px;" name="subContractId" value="351525"/></td>
				</tr>
				<tr>
					<th></th>
...
$("#tj").click(function(){
	demoOneForm.action='${pageContext.request.contextPath}/ysb/ysbsigntime.action';
	demoOneForm.submit();
})
</script>
</html>