...
<div id="total">
	<div id="one">
		<form action="" name="demoOneForm" id="demoOneForm" method="post">
			<table>
				<tr>
					<td colspan="2" style="text-align: center;color: red;font-size: 24px;">1.2 订单状态查询接口</td>
				</tr>
				<tr>
					<th>商户编号:</th>
				...
				<tr>
					<th>订单编号:</th>
					<td><input type="text" style="width:350px;" name="orderId" value="81713582723930527065231148091118"></td>
				</tr>
				<tr>
					<td></td>
...
$("#pay").click(function(){
	demoOneForm.action='${pageContext.request.contextPath}/ysb/ysbsignquery.action';
	demoOneForm.submit();
})
</script>
</html>