...
<center>
	...
	日期：<input type="text" name="flowReportTime" class="flowReportTime" value="" /><br /><br />
	类型:<input type="text" name="type" class="type" value="cj018" /><br /><br />
		...
		$.ajax({
			...
			success:function(data){
				...
				$.ajax({
					...
					success:function(data){
						console.info(data.excelText);
						$(".div").html(data.excelText);
					}
				});
			}
		});
